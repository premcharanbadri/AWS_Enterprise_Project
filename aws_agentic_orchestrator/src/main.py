from src.agent_graph import aws_engine

if __name__ == "__main__":
    print("=== Booting AWS Orchestrator ===")
    ...
    print("\n[Executing Run 1]")
    result_1 = aws_engine.invoke(task_1, config={"configurable": {"thread_id": "run-1"}})
    ...
    print("\n[Executing Run 2]")
    result_2 = aws_engine.invoke(task_2, config={"configurable": {"thread_id": "run-2"}})
